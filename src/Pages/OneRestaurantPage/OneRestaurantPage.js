...
const OneRestaurantPage = () => {
    ...
    const toDesc = () => {
        navigate(`/go/place/${restaurantId.id}/description`);
    };
        ...
        <div className={css.one_page}>
            <div className={css.one_page_bg}>
                ...
                <div className={css.tab_header}>
                    <NavLink
                        to={`/go/place/${oneRestaurant.id}/description`}
                        className={({isActive}) =>
                    ...
                    <NavLink
                        to={`/go/place/${oneRestaurant.id}/photos`}
                        className={({isActive}) =>
                            (isActive ? css.active_link : undefined)}
                    >
                        Фото
                    ...
                    <NavLink
                        to={`/go/place/${oneRestaurant.id}/menu`}
                        className={({isActive}) =>
                            (isActive ? css.active_link : undefined)}
                    >
                        Меню
                    ...
                    <NavLink
                        to={`/go/place/${oneRestaurant.id}/map`}
                        className={({isActive}) =>
                            (isActive ? css.active_link : undefined)}
                    >
                        Карта столиків
                    ...
                    <NavLink
                        to={`/go/place/${oneRestaurant.id}/location`}
                        className={({isActive}) =>
                            (isActive ? css.active_link : undefined)}
                    >
                        Локація
